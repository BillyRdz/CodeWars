const instuctions = `You're on your way to the market when you hear beautiful music coming from a nearby street performer. The notes come together like you wouln't believe as the musician puts together patterns of tunes. As you wonder what kind of algorithm you could use to shift octaves by 8 pitches or something silly like that, it dawns on you that you have been watching the musician for some 10 odd minutes. You ask, "how much do people normally tip for something like this?" The artist looks up. "It's always gonna be about tree fiddy."
...
let answer = `function isLockNessMonster(s) {
  return s.includes('tree fiddy') || s.includes('3.50')
}`;

let arrowAnswer = `const isLockNessMonster = s => s.includes('tree fiddy') || s.includes('3.50')`;
